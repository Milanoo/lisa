                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <select id="provinceSelect" class="form-select">
                                <?php foreach ($provinces as $province): ?>
                                    <option value="<?php echo $province; ?>" <?php if ($province == 'गण्डकी प्रदेश')
                                           echo 'selected'; ?>><?php echo $province; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <i style="color:#d5d5d5; text-align:right; font-size:0.8em">**Lowest number
                                            (Higher Rank) is better</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="row">
                                <div class="col-xl-8 col-lg-8 col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="m-0 font-weight-bold text-primary" id="categoryChartTitle">
                                                Category Analysis</h6>
                                        </div>
                                        <div class="card-body">
        ...
        const updateComparison = () => {
            ...
            Promise.all(Object.keys(fiscalYears).map(fetchData)).then(data => {
                ...
                const countryData = {
                    ...
                    ranks: data.map(fyData => {
                        // Use all valid items for country ranking
                        const allItems = fyData.response.filter(item =>
                            item.score !== "N/A" &&
                            item.score != null &&
                            !isNaN(parseFloat(item.score))
                        );
                        return calculateRank(allItems, selectedLg);
                    })
                };
